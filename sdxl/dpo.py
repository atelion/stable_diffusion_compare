...
pipe.set_adapters(["dpo-lora"], adapter_weights=[1.2])
pipe.to("cuda")
...
# prompt = "A red fox reading a book under a giant, glowing mushroom in a starlit forest."#1.9
...
print(top_score)
top_images[0].save(f"{top_score}-DPO.png")